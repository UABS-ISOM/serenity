...
var PasswordresetPage = /** @class */ (function () {
    ...
    PasswordresetPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-passwordreset",template:/*ion-inline-start:"/Users/shohilkishore/Desktop/Work/Old/Johnny Chan/cyberbully-checker (latest working ios version)/src/pages/passwordreset/passwordreset.html"*/'<!-- Remove ion-list to ensure email is tappable. -->\n<ion-content class="animated fadeIn login auth-page background">\n  <div class="login-content">\n    <ion-card>\n      <ion-card-content>\n        <div class="spacer" style="height: 10px;"></div>\n        <ion-item class="text-1x">\n          <ion-input\n            type="email"\n            [(ngModel)]="email"\n            placeholder="Email"\n          ></ion-input>\n          <ion-icon name="mail" item-start class="text-primary"></ion-icon>\n        </ion-item>\n        <button\n          class="text-1x"\n          ion-button\n          icon-start\n          block\n          color="primary"\n          tappable\n          (click)="reset()"\n        >\n          Reset\n        </button>\n        <div text-center margin-top>\n          <span ion-text color="secondary" tappable (click)="goback()"\n            >Back</span\n          >\n        </div>\n      </ion-card-content>\n    </ion-card>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/shohilkishore/Desktop/Work/Old/Johnny Chan/cyberbully-checker (latest working ios version)/src/pages/passwordreset/passwordreset.html"*/,
        }),
